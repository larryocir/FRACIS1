Public Class frmtransac
    ...
    Sub UpdateDeleteCommodities()
        Dim arrcrops As New ArrayList
        Dim i As Integer = 0
        openCon()
        Try
            With cmd
                    ...
                    Select Case reader(0)
                        Case "Rice"
                            If chkRice.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Corn"
                            If chkCorn.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Coconut"
                            If chkCoconut.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Vegetables"
                            If chkVegetables.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Fruits"
                            If chkFruits.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Root Crops"
                            If chkRootCrops.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                    End Select
                Loop
        ...
        While i <> arrcrops.Count
            openCon()
            Try
                With cmd
                    .Connection = con
                    .CommandText = ("DELETE FROM `crops` WHERE `crops`.`crops_id` = " & arrcrops(i) & "")
                    .ExecuteNonQuery()
                End With
            Catch ex As Exception
                MsgBox(ex.Message, MsgBoxStyle.Exclamation)
    ...
    Sub UpdateDeleteAnimals()
        ...
        Try
            With cmd
                .Connection = con
                .CommandText = ("SELECT animal_type, animal_cat, animal_id FROM animal WHERE mem_id =" & GlobalId & "")
                reader = cmd.ExecuteReader()
                Do While reader.Read = True
                    Select Case reader(0)
                        Case "Chicken"
                            If chkChicken.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Duck"
                            If chkDuck.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Goose"
                            If chkGoose.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Turkey"
                            If chkTurkey.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Carabao"
                            If chkCarabao.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Cattle"
                            If chkCattle.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Goat"
                            If chkGoat.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Swine"
                            If chkSwine.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Dog"
                            If chkDog.Checked = False Then
                                arrcrops.Add(reader(2))
                            End If
                        Case "Cat"
        ...
        While i <> arrcrops.Count
            ...
            Try
                With cmd
                    .Connection = con
                    .CommandText = ("DELETE FROM `animal` WHERE animal_id = " & arrcrops(i) & "")
                    .ExecuteNonQuery()
                End With
            Catch ex As Exception
                MsgBox(ex.Message, MsgBoxStyle.Exclamation)
    ...
    ''TAB CROPS
    'Private Sub btnAddCrops_Click(sender As Object, e As EventArgs)
    ...
    'Private Sub txtLandArea_KeyPress(sender As Object, e As KeyPressEventArgs)
    '    Dim DecimalSeparator As String = Application.CurrentCulture.NumberFormat.NumberDecimalSeparator
    '    e.Handled = Not (Char.IsDigit(e.KeyChar) Or Asc(e.KeyChar) = 8 Or (e.KeyChar = DecimalSeparator And sender.Text.IndexOf(DecimalSeparator) = -1))
    'End Sub

    'Private Sub btnRemoveCrops_Click(sender As Object, e As EventArgs)
    ...
    'Private Sub dgrdcrop_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs)
    ...
    'Private Sub btnEditCrops_Click(sender As Object, e As EventArgs)
    ...
    'Private Sub btnAddAnimal_Click(sender As Object, e As EventArgs)
    ...
    'Private Sub btnEditAnimal_Click(sender As Object, e As EventArgs)
    '    Dim newDataRow As DataGridViewRow
    ...
    'Private Sub dgrdanimal_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs)
    '    If e.RowIndex >= 0 Then
    '        index = e.RowIndex
    ...
    'Private Sub btnRemoveAnimal_Click(sender As Object, e As EventArgs)
    ...
    'Private Sub btnSaveUpdate2_Click(sender As Object, e As EventArgs)
